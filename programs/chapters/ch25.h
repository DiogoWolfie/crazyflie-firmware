...
int main ()
{
    ...
    <= 4.0* pi && abs ( att_est . q ) <= 4.0* pi && abs ( att_est . r ) <= 4.0* pi )
    {
        ...
        att_cont.control ( hor_cont . phi_r , hor_cont . theta_r , psi_r , att_est . phi , att_est .
        theta , att_est . psi , att_est .p , att_est .q , att_est . r ) ;
        mixer.actuate ( ver_cont . f_t /( cos ( att_est . phi ) * cos ( att_est . theta ) ) , att_cont .
        thau_phi , att_cont . thau_theta , att_cont . thau_psi ) ;
        }
    }
